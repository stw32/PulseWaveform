...
You need to add an animation - can save the waveforms not printed above as pngs, 
then call them in the gg_anim plot. 

Also, need to update the general purpose script with the spectal features being added to all_outputs (so there is consistency between this and the script people then use). 
Then need to show to Johanna. 
