...
These packages may need to be installed first. All are available on [CRAN](https://cran.r-project.org) and can be installed with install.packages(), other than SplinesUtils which is available [here](https://github.com/ZheyuanLi/SplinesUtils). 
